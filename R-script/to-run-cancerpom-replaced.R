...
location.of.generated.files <- paste0(base.location, "generated-files-cancerpom-replaced")
...
source(paste(location.of.r.scripts,"argument-prep-for-jags-pom-replaced.R",sep="/"))
