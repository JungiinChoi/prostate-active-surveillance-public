...
location.of.generated.files <- paste0(base.location, "generated-files-seq-mri-form2-nomainmri-ind-pirads")
...
source(paste(location.of.r.scripts,"data-prep-for-jags-seq-mri-form2-nomainmri-ind-pirads.R",sep="/"))

#Load arguments for JAGS
source(paste(location.of.r.scripts,"argument-prep-for-jags-seq-mri-form2-nomainmri-ind-pirads.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-mri-form2-nomainmri-ind-pirads.txt", sep="/"),
