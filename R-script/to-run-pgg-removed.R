...
location.of.generated.files <- paste0(base.location, "generated-files-seq-pgg-removed")
...
source(paste(location.of.r.scripts,"data-prep-for-jags-pgg-removed.R",sep="/"))

#Load arguments for JAGS
source(paste(location.of.r.scripts,"argument-prep-for-jags-pgg-removed.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-pgg-removed.txt", sep="/"),
