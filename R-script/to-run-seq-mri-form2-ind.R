...
location.of.generated.files <- paste0(base.location, "generated-files-seq-form2-ind")
...
source(paste(location.of.r.scripts,"argument-prep-for-jags-seq-mri-form2.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-form2-ind.txt", sep="/"),
