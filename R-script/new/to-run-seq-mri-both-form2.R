...
location.of.generated.files <- paste0(base.location, "generated-files/seq-mri-both-form2")
...
source(paste(location.of.r.scripts,"argument-prep-for-jags-seq-mri-both-form2.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, parameters.to.save=params,
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-mri-both-form2.txt", sep="/"),
