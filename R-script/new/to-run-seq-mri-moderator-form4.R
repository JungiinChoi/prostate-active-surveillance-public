...
# location.of.r.scripts <- paste0(base.location, "R-script/new/")
# location.of.generated.files <- paste0(base.location, "generated-files-new/generated-files-seq-mri-moderator-form4")

base.location <- "/users/zwang3/PAS/"
location.of.data <- paste0(base.location, "data")
location.of.r.scripts <- paste0(base.location, "code")
location.of.generated.files <- paste0(base.location, "generated-files/seq-mri-moderator-form4")
...
source(paste(location.of.r.scripts,"data-prep-for-jags-seq-mri-moderator.R",sep="/"))

#Load arguments for JAGS
source(paste(location.of.r.scripts,"argument-prep-for-jags-seq-mri-moderator-form3.R",sep="/"))

#Define JAGS model
#source(paste(location.of.r.scripts,"JAGS-prediction-model-seq-addmri.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, parameters.to.save=params,
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-mri-moderator-form4.txt", sep="/"),
           n.thin=n.thin, n.chains=n.chains, n.burnin=n.burnin, n.iter=n.iter)
out<-outj$BUGSoutput
#save(out, file = "generated-files/generated-files-new/jags-moderator-form3.RData")
...
pdf("traceplot_moderator_form4.pdf")
traceplot(out, mfrow=c(2,2), varname = c("pgg_slope1", "pgg_slope2", "pgg_slope3"))
dev.off()
