...
# location.of.generated.files <- paste0(base.location, "generated-files-new/generated-files-seq-mri-moderator-form3")

base.location <- "/users/zwang3/PAS/"
location.of.data <- paste0(base.location, "data")
location.of.r.scripts <- paste0(base.location, "code")
location.of.generated.files <- paste0(base.location, "generated-files/seq-mri-moderator-form3")
...
outj<-jags(jags_data, inits=inits, parameters.to.save=params,
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-mri-moderator-form3.txt", sep="/"),
