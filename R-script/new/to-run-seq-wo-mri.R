...
# location.of.generated.files <- paste0(base.location, "generated-files-seq-wo-mri")
...
source(paste(location.of.r.scripts,"data-prep-for-jags-seq-wo-mri.R",sep="/"))

#Load arguments for JAGS
source(paste(location.of.r.scripts,"argument-prep-for-jags-seq-wo-mri.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, parameters.to.save=params,
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-wo-mri.txt", sep="/"),
