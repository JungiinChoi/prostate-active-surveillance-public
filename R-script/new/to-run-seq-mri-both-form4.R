...
# location.of.generated.files <- paste0(base.location, "generated-files-seq-mri-both")

base.location <- "/users/zwang3/PAS/"
location.of.data <- paste0(base.location, "data")
location.of.r.scripts <- paste0(base.location, "code")
location.of.generated.files <- paste0(base.location, "generated-files/seq-mri-both-form4")
...
source(paste(location.of.r.scripts,"data-prep-for-jags-seq-mri-both.R",sep="/"))

#Load arguments for JAGS
source(paste(location.of.r.scripts,"argument-prep-for-jags-seq-mri-both-form3.R",sep="/"))
...
outj<-jags(jags_data, inits=inits, parameters.to.save=params,
           model.file=paste(location.of.r.scripts, 
                            "JAGS-prediction-model-seq-mri-both-form4.txt", sep="/"),
