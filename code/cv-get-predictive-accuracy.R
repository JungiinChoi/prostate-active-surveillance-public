...
location.of.generated.folder <- paste(location.of.generated.files, "/K=",foldnum,sep="")
...
for(group in 1:foldnum){
  obs_eta_cv <- read.csv(paste0(location.of.generated.folder, "/eta-subj-",group,".csv"))
	fit_eta_cv <- read.csv(paste0(location.of.generated.folder, "/jags-prediction-eta.track-both",group,".csv"))
