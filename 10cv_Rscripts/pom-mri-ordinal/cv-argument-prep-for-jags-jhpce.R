...
inits <- function() {
  ...
  pirads_slope1 <- rnorm(npred_pirads + (K-1),mean=0,sd=0.25)
  pirads_slope2 <- rnorm(npred_pirads + (K-1),mean=0,sd=0.25)
  pirads_coef_mean = rnorm(npred_pirads + (K-1),mean=0,sd=0.25) 
  pirads_coef_mean[(npred_pirads+1):(npred_pirads+(K-1))] = abs(pirads_coef_mean[(npred_pirads+1):(npred_pirads+(K-1))])
  pirads_slope1[(npred_pirads+1):(npred_pirads+(K-1))] = abs(pirads_slope1[(npred_pirads+1):(npred_pirads+(K-1))])
  pirads_slope2[(npred_pirads+1):(npred_pirads+(K-1))] = abs(pirads_slope2[(npred_pirads+1):(npred_pirads+(K-1))])
...
params <- c("eta.track",
            ...
            "pirads_int1", "pirads_int2", "pirads_int3",
