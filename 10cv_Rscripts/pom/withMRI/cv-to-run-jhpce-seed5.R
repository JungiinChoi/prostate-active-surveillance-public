...
location.of.r.scripts <- paste0(base.location, "code-pom-withmri")
location.of.generated.files <- paste0(base.location, "generated-files-cv-pommri")
...
# for(to.mask in 3:10){
  to.mask = 5
load("generated-files-cv-pommri/IOP-data-shaping-work-space.RData")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-jhpce.txt", sep="/"),
