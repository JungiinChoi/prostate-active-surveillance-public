...
location.of.r.scripts <- paste0(base.location, "code-seq-mri-nomainmri")
location.of.generated.files <- paste0(base.location, "generated-files-cv-seq-mri-nomainmri")
