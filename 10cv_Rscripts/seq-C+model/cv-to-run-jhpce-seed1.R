...
location.of.r.scripts <- paste0(base.location, "code-seq")
#location.of.r.scripts <- paste0(base.location, "10cv_Rscripts/seq-C+model")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-seq-C+.txt", sep="/"),
