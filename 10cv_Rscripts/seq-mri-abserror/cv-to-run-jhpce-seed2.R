...
location.of.r.scripts <- paste0(base.location, "code-seq-mri-abserror")
#location.of.r.scripts <- paste0(base.location, "10cv_Rscripts/seq-mri-abserror")
location.of.generated.files <- paste0(base.location, "generated-files-cv-seq-mri-abserror")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-seq-mri-abserror.txt", sep="/"),
