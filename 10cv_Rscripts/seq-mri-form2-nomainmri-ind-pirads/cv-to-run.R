...
location.of.r.scripts <- paste0(base.location, "10cv_Rscripts/seq-mri-form2-nomainmri-ind-pirads")
location.of.generated.files <- paste0(base.location, "generated-files-cv/seq-mri-form2-nomainmri-ind-pirads")
