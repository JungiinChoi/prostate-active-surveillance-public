...
location.of.generated.files <- paste0(base.location, "generated-files-cv/seq/withoutMRI/", sep="")
...
### 4. Load needed data and predictions
load(paste(base.location,"generated-files-cv/IOP-data-shaping-work-space.RData", sep="/"))
...
for(group in 1:10){
  obs_eta_cv <- read.csv(paste0(location.of.generated.files, "/eta-subj-",group,".csv"))
