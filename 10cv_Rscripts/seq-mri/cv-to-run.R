...
location.of.r.scripts <- paste0(base.location, "10cv_Rscripts/seq")
location.of.generated.files <- paste0(base.location, "generated-files-cv/seq")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-seq-addmri.txt", sep="/"),
