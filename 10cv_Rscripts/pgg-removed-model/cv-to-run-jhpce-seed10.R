...
location.of.r.scripts <- paste0(base.location, "code-pgg-removed")
# location.of.r.scripts <- paste0(base.location, "10cv_Rscripts/pgg-removed-model")
location.of.generated.files <- paste0(base.location, "generated-files-cv-pgg-removed")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-pgg-removed.txt", sep="/"),
