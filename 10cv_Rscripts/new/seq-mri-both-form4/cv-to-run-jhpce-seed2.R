...
location.of.r.scripts <- paste0(base.location, "code-seq-mri-both-form4")
location.of.generated.files <- paste0(base.location, "generated-files-cv-seq-mri-both-form4")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-seq-mri-both.txt", sep="/"),
