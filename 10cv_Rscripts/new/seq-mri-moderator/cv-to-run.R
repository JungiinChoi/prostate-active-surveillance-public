...
location.of.r.scripts <- paste0(base.location, "10cv_Rscripts/new/seq-mri-moderator")
location.of.generated.files <- paste0(base.location, "generated-files-cv/new/seq-mri-moderator")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-seq-mri-moderator.txt", sep="/"),
