...
location.of.r.scripts <- paste0(base.location, "code-seq-mri-moderator")
location.of.generated.files <- paste0(base.location, "generated-files-cv-seq-mri-moderator")
