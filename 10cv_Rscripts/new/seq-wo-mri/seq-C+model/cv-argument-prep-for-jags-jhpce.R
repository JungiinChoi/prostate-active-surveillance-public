...
inits <- function() {
  ...
  pgg_slope1 <- rnorm(npred_pgg + 2*(nlevel_cancer-1),mean=0,sd=0.25)
  pgg_slope2 <- rnorm(npred_pgg + 2*(nlevel_cancer-1),mean=0,sd=0.25)
  pgg_slope3 <- rnorm(npred_pgg + 2*(nlevel_cancer-1),mean=0,sd=0.25)
  pgg_coef_mean = rnorm(npred_pgg + (nlevel_cancer-1),mean=0,sd=0.25)
  pgg_coef_mean[(npred_pgg+1):(npred_pgg+2*(nlevel_cancer-1))] = abs(pgg_coef_mean[(npred_pgg+1):(npred_pgg+(nlevel_cancer-1))])
  ...
  pgg_slope1[(npred_pgg+nlevel_cancer):(npred_pgg+2*(nlevel_cancer-1))] <- abs(pgg_slope1[(npred_pgg+nlevel_cancer):(npred_pgg+2*(nlevel_cancer-1))])
  pgg_slope2[(npred_pgg+nlevel_cancer):(npred_pgg+2*(nlevel_cancer-1))] <- abs(pgg_slope2[(npred_pgg+nlevel_cancer):(npred_pgg+2*(nlevel_cancer-1))])
  pgg_slope3[(npred_pgg+nlevel_cancer):(npred_pgg+2*(nlevel_cancer-1))] <- abs(pgg_slope3[(npred_pgg+nlevel_cancer):(npred_pgg+2*(nlevel_cancer-1))])
