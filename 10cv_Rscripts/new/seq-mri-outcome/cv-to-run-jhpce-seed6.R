...
location.of.r.scripts <- paste0(base.location, "code-seq-mri-outcome")
location.of.generated.files <- paste0(base.location, "generated-files-cv-seq-mri-outcome")
...
outj<-jags(jags_data, inits=inits, 
           ...
           model.file=paste(location.of.r.scripts, 
                            "cv-JAGS-prediction-model-seq-mri-outcome.txt", sep="/"),
